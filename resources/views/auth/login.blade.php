        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="text-center mb-4">
                    ...
                    <h4>{{ __("Sign in") }}</h4>
                    <p class="text-muted mb-4">{{ __("Sign in to continue to chatapp.") }}</p>
                </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 bg-soft-light input-group-lg rounded-lg">
                                        ...
                                        <input id="email" type="email" class="form-control bg-soft-light border-light @error('email') is-invalid @enderror" name="email" value="{{ old('email', 'admin@test.com') }}" required autocomplete="email" autofocus placeholder="{{ __("Enter Email") }}">
                                        @error('email')
