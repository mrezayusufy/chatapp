        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="text-center mb-4">
                    ...
                    <h4>{{ __("Sign up") }}</h4>
                    <p class="text-muted mb-4">{{ __("Get your chatapp account now.") }}</p>
                        ...
                        <div class="p-3">
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="mt-4 text-center">
                                    <p class="text-muted mb-0">{{ __("By registering you agree to the chatapp") }} <a href="#" class="text-primary">{{ __("Terms of Use") }}</a></p>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <p>{{ __("© 2020 chatapp. Crafted with") }}</p>
                </div>
            </div>
        </div>
    </div>
